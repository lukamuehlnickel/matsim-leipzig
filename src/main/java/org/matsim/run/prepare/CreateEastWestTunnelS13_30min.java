...
public class CreateEastWestTunnelS13_30min {
    ...
    private static final TransitScheduleFactory scheduleFactory = ScenarioUtils.createScenario(ConfigUtils.createConfig()).getTransitSchedule().getFactory();
        ...
        public static void main (String[]args){
            ...
            for (int i = 6 * 3600; i < 23 * 3600; i += 1800) {
            ...
            new TransitScheduleWriter(scenario.getTransitSchedule()).writeFile(root.resolve("transit-Schedule-complete_30min.xml.gz").toString());
            new MatsimVehicleWriter(scenario.getTransitVehicles()).writeFile(root.resolve("transit-vehicles-complete_30min.xml.gz").toString());
        }
